    ...
    <View style={styles.container}>
        ...
        <View style={{backgroundColor: "#FFFFFF", borderColor: "#000", borderWidth: 0.2}}>
          ...
          <View style={{display: "flex", flexDirection: "row", justifyContent: "space-between", paddingRight: 10, paddingVertical: 6, paddingLeft: 100}}>
            ...
            <TouchableOpacity 
              style={{backgroundColor: "#000000", borderRadius: 4, paddingHorizontal: 6, height: 24, display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center"}}
            ...
            >
                <Text style={{color: "#FFFFFF", fontFamily: "Roboto-Black"}}>Follow</Text>
            </TouchableOpacity>
          </View>
          <View>
